...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  ProductBloc() : super(ProductInitial()) {
    on<ProductDetailRequestEvent>((event, emit) async  {
      ...
      var getVariantType = await productDetail.getProductVariant(event.product_id);
      var productCategory = await productDetail.getProductCategory(event.category_id);
      emit(ProductRequestResponseState(productGallery: getImages,productVariantList: getVariantType,productCategory:productCategory));  
    });
  }
}
